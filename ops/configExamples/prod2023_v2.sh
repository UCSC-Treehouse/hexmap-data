...
# View servers allowed to edit maps. 128.114.198.36 = hexcalc.ucsc.edu 128.114.198.35 = hexmap.gi.ucsc.edu
export VIEW_SERVER_ADDRS=128.114.198.36

# Bookmarks are created by this view server.
export VIEWER_URL=https://tumormap.ucsc.edu

# IP socket and user view of server URL. When running in Docker without network="host", use 0.0.0.0:$PORT
# Otherwise, use 127.0.0.1:$PORT
